...
import { userAPI, companyAPI, userRoleAPI } from '../services/api';
import { User, Company, UserRole } from '../services/mockData';
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">{t('user')}</h1>
          <p className="mt-2 text-gray-600 dark:text-gray-400">{t('manageUsers')}</p>
        </div>
      ...
      {isAddModalOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white dark:bg-[#0d1117] rounded-xl shadow-lg border border-gray-200 dark:border-[#1f242d] w-full max-w-2xl max-h-[90vh] overflow-y-auto"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="p-6 border-b border-gray-200 dark:border-[#1f242d]">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">{t('add')} {t('user')}</h3>
            </div>
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setCurrentUser({ ...currentUser, createdAt: e.target.value })}
                  />
                </div>
              </div>
            </div>
            <div className="p-6 border-t border-gray-200 dark:border-[#1f242d] flex justify-end space-x-3">
              ...
              <button
                ...
                onClick={() => handleAdd(currentUser as Omit<User, 'id'>)}
              >
                {t('save')}
              </button>
            </div>
      ...
      {isEditModalOpen && (
        ...
        >
          ...
          >
            <div className="p-6 border-b border-gray-200 dark:border-[#1f242d]">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">{t('edit')} {t('user')}</h3>
            </div>
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
